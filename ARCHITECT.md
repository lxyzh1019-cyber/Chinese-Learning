# ARCHITECT.md — Chinese Adventure: Complete App Blueprint
...
It was the repository root `CLAUDE.md` until 2026-09-22, when the root file
became the cross-project working rules (v2.1). Nothing here changed in that
move: this is the repo-specific architecture, and it is what a session must
read before touching this app's code, state, curriculum or sync. The working
rules say *how* to work; this says *what the app is*.
